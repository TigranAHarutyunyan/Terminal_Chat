...
class Client{
    private:
        ...
        void get_another_client_username(boost::asio::io_context &ioContext, Client &another_client, boost::asio::ip::tcp::acceptor &tcp_acceptor, std::string client_to_connect);
        ...
        void start_input_thread(Client &another_client, std::string client_message);
    ...
    public:
        Client(boost::asio::io_context& io_context , const std::string &user_name , const std::string &ip_address, const std::string &server_ip, const std::string &server_passwd);
